    ...
    = (Order) => class PosOrderInherit extends Order {
        ...
        export_for_printing() {
            ...
            if (self.invoice_id){
                ...
                data.address_change_id = this.pos.config.address_change_id
                data.address_change_street = this.pos.config.address_change_street
                data.address_change_street2 = this.pos.config.address_change_street2
                data.address_change_city = this.pos.config.address_change_city
                data.address_change_phone = this.pos.config.address_change_phone
                data.address_change_activity_description = this.pos.config.address_change_activity_description
            }
